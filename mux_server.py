...
import select, socket, serial, datetime, sys, os, time
...
# Deafults
LOG_FILENAME = "mux.log"
LOG_LEVEL = logging.INFO  # Could be e.g. "DEBUG" or "WARNING"

# Define and parse command line arguments
parser = argparse.ArgumentParser(description="MVT service")
...
REVISION = 1.2
MODULE_DATE = '2016-05-30'
AUTHOR = 'TRAVIS PARKER'



"""
FILES THAT NEEDS TO BE IN THE /home/pi/Desktop/ DIRECTORY
config.xml
mux_server.py
mux
"""
...
cp mux /etc/init.d/mux
chmod +x /etc/init.d/mux
chmod +x mux_server.py
update-rc.d mux defaults
